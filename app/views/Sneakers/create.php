        ...
        <div class="col-6">
            ...
            <form action="<?= URLROOT; ?>/SneakersController/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="text"  class="form-control <?= isset($data['errors']['prijs']) ? 'is-invalid' : ''; ?>" id="prijs" value="<?= $_POST['prijs'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="gewicht" type="number" min="0" max="4000" step="0.01" class="form-control <?= isset($data['errors']['gewicht']) ? 'is-invalid' : ''; ?>" id="gewicht" value="<?= $_POST['gewicht'] ?? ''; ?>">
