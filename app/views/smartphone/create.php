            ...
            <form action="<?= URLROOT; ?>/SmartphoneController/create" method="post">
               <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="schermgrootte" type="number" min="0" max="4000" step="0.01" class="form-control <?= isset($data['errors']['schermgrootte']) ? 'is-invalid' : ''; ?>" id="schermgrootte" value="<?= $_POST['schermgrootte'] ?? ''; ?>">
